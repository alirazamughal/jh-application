package jh.defualt.application.repository;

import jh.defualt.application.JhDefaultApp;
import jh.defualt.application.config.Constants;
import jh.defualt.application.config.audit.AuditEventConverter;
import jh.defualt.application.domain.PersistentAuditEvent;
...
import static jh.defualt.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
